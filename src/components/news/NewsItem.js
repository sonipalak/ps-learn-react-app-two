...
const NewsItem = (props) => {
  ...
  return (
    <div className='item-box'>
      <div className='item-img'><img src={!imageUrl ? "https://img.freepik.com/free-vector/no-multiply-font-vector-text-typography_53876-168227.jpg" : imageUrl} className="card-img-top" alt="..." /></div>
      <div className='details'>
        ...
        <span className='publishDate'>
          <span>
            ...
            <strong>{!author ? "No Author Available" : author},</strong>
          </span>
          <span>
